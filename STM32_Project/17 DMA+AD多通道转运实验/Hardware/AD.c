...
void AD_Init(void)
{
	...
	DMA_InitStucture.DMA_PeripheralBaseAddr = (uint32_t)&ADC1->DR;
	DMA_InitStucture.DMA_PeripheralDataSize = DMA_PeripheralDataSize_HalfWord;
	DMA_InitStucture.DMA_PeripheralInc = DMA_PeripheralInc_Disable;
	DMA_InitStucture.DMA_MemoryBaseAddr = (uint32_t)AD_Value;
	DMA_InitStucture.DMA_MemoryDataSize = DMA_MemoryDataSize_HalfWord;
	DMA_InitStucture.DMA_MemoryInc = DMA_MemoryInc_Enable;
	DMA_InitStucture.DMA_BufferSize = 4;
	DMA_InitStucture.DMA_DIR = DMA_DIR_PeripheralSRC;
	DMA_InitStucture.DMA_M2M = DMA_M2M_Disable;
	DMA_InitStucture.DMA_Mode = DMA_Mode_Circular;
